...
export const alert = ({ message, color }: Props) => {
  return (
    <div
      className={
        `"mb-3 hidden w-full items-center rounded-lg px-6 py-5 text-base text-warning-800 data-[te-alert-show]:inline-flex bg-${color}-100`
      }
      role="alert"
      data-te-alert-init
      data-te-alert-show>
